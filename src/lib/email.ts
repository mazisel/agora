...
export async function sendEmail(
  ...
  try {
    ...
    const mailOptions = {
      from: {
        name: process.env.SMTP_FROM_NAME || 'Team Management System',
...
export const emailTemplates = {
  ...
  taskAssigned: (taskTitle: string, assignedBy: string, dueDate?: string): EmailTemplate => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Görev detaylarını görmek için sisteme giriş yapabilirsiniz.</p>
        <p>İyi çalışmalar!</p>
      </div>
    `,
  ...
  userWelcome: (userName: string, tempPassword: string): EmailTemplate => ({
    subject: 'Team Management System\'e Hoş Geldiniz',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #2563eb;">Hoş Geldiniz!</h2>
        <p>Merhaba ${userName},</p>
        <p>Team Management System'e hoş geldiniz! Hesabınız başarıyla oluşturuldu.</p>
        <div style="background-color: #f3f4f6; padding: 20px; border-radius: 8px; margin: 20px 0;">
        ...
        <p>Sisteme giriş yapmak için profil sayfanızı ziyaret edebilirsiniz.</p>
        <p>İyi çalışmalar!</p>
      </div>
    `,
    text: `Hoş Geldiniz ${userName}!\n\nTeam Management System'e hoş geldiniz! Hesabınız başarıyla oluşturuldu.\n\nGeçici Şifre: ${tempPassword}\n\nİlk giriş yaptığınızda şifrenizi değiştirmeniz önerilir.`
  }),
  ...
  projectAssigned: (projectTitle: string, assignedBy: string, role: string): EmailTemplate => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Proje detaylarını görmek için sisteme giriş yapabilirsiniz.</p>
        <p>İyi çalışmalar!</p>
      </div>
    `,
